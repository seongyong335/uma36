...
<br>
  ...
  <h3> 🐎Uma 36이란? </h3>
   <p> 우마게임에서 우마는 경마라는 의미를 갖고 있으며  텍스트 기반으로 만들어진 경마게임을 말합니다.
       텍스트 기반 경마게임 프로젝트는 자바로 개발되었습니다. 사용자는 게임에서 배당률과 승률을 계산하여 결과를 확인할 수 있습니다. 
       프로젝트는 객체지향적인 설계와 사용자 상호작용을 갖추고 있어 재미와 전략을 경험할 수 있습니다. <br><br>
       텍스트 기반으로 구현되었지만 직관적이고 즐거운 플레이 경험을 제공합니다. 
       이 프로젝트는 경마 게임을 컴퓨터로 구현한 것으로, 플레이어는 선택지를 통해 가상의 경마를 즐길 수 있습니다.
       프로젝트는 모듈화된 클래스 구조로 설계되어 유지보수와 확장이 용이하며, 코드의 가독성과 재사용성에도 신경쓰여 구현되었습니다.<br><br>
