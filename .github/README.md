...
<br>
  ...
  <h3> 🐎Uma 36이란? </h3>
   <p> 우마게임에서 우마는 경마라는 의미를 갖고 있으며  텍스트 기반으로 만들어진 경마게임을 말합니다. <br> <br>
       이 프로젝트는 텍스트 기반 경마게임으로, 배당률과 승률을 계산하고 결과를 플레이어에게 제공합니다. <br>
       자바로 개발되었으며, 객체지향적인 설계와 사용자 상호작용을 통해 재미와 전략을 경험할 수 있습니다. <br>
       텍스트 기반으로 구현되었지만 직관적이고 즐거운 플레이 경험을 제공합니다. <br>
       저희는 텍스트 기반 경마게임을 개발한 프로젝트 팀입니다. <br>
       이 프로젝트는 자바를 사용하여 구현되었으며, 사용자가 텍스트 기반 인터페이스를 통해 경마 게임을 즐길 수 있도록 제작되었습니다. <br>
       경마게임은 많은 사람들이 즐기는 스포츠 중 하나인데, 저희는 이를 컴퓨터로 구현하여 가상의 경마 환경을 제공합니다. <br>
       이 게임에서는 플레이어가 다양한 선택지를 통해 경마를 진행하고, 결과에 따라 배당률을 계산하여 출력합니다. <br>
       이 프로젝트는 객체지향 프로그래밍의 원칙에 따라 설계되었습니다. <br>
       각 기능과 역할을 담당하는 클래스들이 모듈화되어 있으며, 이를 통해 유지보수와 확장이 용이합니다. <br>
       또한, 코드의 가독성과 재사용성을 고려하여 구현되었습니다. <br>
       이 프로젝트는 텍스트 기반으로 구현되었지만, 사용자들에게 직관적인 경험과 재미를 제공합니다. <br> 
       간결하고 명확한 명령어를 입력하여 게임을 조작하고 결과를 확인할 수 있으며, 게임 진행과 함께 배당률과 승률의 변화를 관찰하며 전략을 세울 수 있습니다. <br>
       경마게임 프로젝트는 실제 경마의 분위기와 전략을 텍스트 기반으로 재현한 것으로, 플레이어들에게 즐거움과 도전을 제공합니다. <br>
       다양한 상황에서 배당률과 승률을 고려하며 최적의 선택을 찾는 재미를 경험해 보세요. 텍스트 기반 경마게임의 세계에 빠져보십시오! </p>
